...
<header class="header header-sticky header-dark">
      <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark">
          <a href="\" class="navbar-brand mr-8"><img src="assets/images/logo.svg" alt="Logo"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="https://podcast.workcityafrica.com/" target="_blank">Podcast</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://blog.workcityafrica.com/" target="_blank">Blog</a>
              </li>
              <li class="nav-item">
            ...
            <a href="auth" class="btn btn-light">Sign In <i class="icon-log-in"></i></a>
          </div>
        </nav>
      </div>
    </header>