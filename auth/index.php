...
<!-- Mirrored from codescandy.com/coach/v/2.0.0-alpha/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Dec 2020 21:26:35 GMT -->
<head>
...
<body>
        ...
        <div class="container-lg">
            ...
            <span class="icon-bar bottom-bar"></span>
              ...
              <i class="fas fa-times"></i>
                  ...
                  <li class="dropdown-submenu ">
                    <a
                      class="dropdown-list-group-item dropdown-toggle"
                      href="#"
                    >
                      <div class="d-flex align-items-center">
                        <div
                  ...
                  <li class="dropdown-submenu ">
                    ...
                    >
                      ...
                      <li>
                        <a
                          class="dropdown-item"
                          href="pages/podcast-thumbnail.html"
                        >
                          Thumbnail</a
                        >
                      </li>
              ...
              <li class="nav-item dropdown">
                ...
                >
                 ...
                 Resources
                                                                            ...
                                                                            <ul class="dropdown-menu dropdown-menu-md dropdown-menu-arrow dropdown-menu-right dropdown-menu-xl-left " aria-labelledby="menu-4">

                                                                                <li class="dropdown-submenu">
                                                                                    <a class="dropdown-list-group-item dropdown-toggle" href="#">


                                                                                        <h4 class="h5">Help Center <span class="text-primary font-12 ml-1">(New)</span></h4>
                                                                                        <p class="text-muted mb-0 font-12">
                                                                                    ...
                                                                                    <ul class="dropdown-menu dropdown-menu-lg-right">
                                                                                        ...
                                                                                        <li>
                                                                                          <a
                                                                                            class="dropdown-item"
                                                                                            href="pages/help-center-category.html"
                                                                                          >
                                                                                            Category</a
                                                                                          >
                                                                                        </li>
                                                                                        ...
                                                                                        <li>
                                                                                          <a
                                                                                            class="dropdown-item"
                                                                                            href="pages/help-center-profile-member.html"
                                                                                          >
                                                                                        ...
                                                                                        <li class="dropdown-submenu">
                                                                                            <a class="dropdown-list-group-item dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                                                <h4 class="h5">Webinar<span class="text-primary font-12 ml-1">(New)</span></h4>
                                                                                                <p class="text-muted mb-0 font-12">
                                                                                  ...
                                                                                  Order Completed
                                                                                                                                ...
                                                                                                                                <li class="nav-item dropdown">
                                                                                                                                   ...
                                                                                                                                   Docs
                                                                                                                                    ...
                                                                                                                                    <ul class="dropdown-menu dropdown-menu-arrow dropdown-menu-right dropdown-menu-xl-left dropdown-menu-md  " aria-labelledby="menu-7">
                                                                                                                                        <li>
                                                                                                                                            ...
                                                                                                                                            <a class="dropdown-list-group-item" href="docs/snippet-overview.html">
                                                                                                                                                <div class="d-flex align-items-center">
                                                                                                                                                    ...
                                                                                                                                                    <div>
                                                                                                                                                        ...
                                                                                                                                                        <span class="font-12 text-muted">Ready to use components</span>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                            </a>
                                                                                                                                        </li>
                                                                                                                                        <li>
                                                                                                                                            <a class="dropdown-list-group-item" href="docs/changelog.html">
                                                                                                                                                <div class="d-flex align-items-center">
                                                                                                                                                    ...
                                                                                                                                                    <div>
                                                                                                                                                        <h5 class=" mb-0 ">Changelog <span class="text-primary font-12 ml-1 ">2.0.0</span></h5>
    ...
    <!-- hero section -->
    <div style="background: url(assets/images/hero-slide.jpg); background-size: cover; background-repeat: no-repeat; background-position: center;">
        <div class="container">
            <div class="row">
                <div class="offset-xl-2 col-xl-8 col-md-12 col-12">
                    <div class="py-13 pt-lg-19 pb-lg-19 text-center text-light">
                        <h1 class="display-3 font-weight-bold text-white mb-3 lh-1">
                            Become the hero of your own story
                        </h1>
                        <p class="px-lg-14 mb-5 lead">
                            Join our Coach community of like-minded individuals.<br /> Get your ticket to the 2020 event.
                        </p>
    ...
    <div class="pt-16 pb-16 bg-primary">
      <div class="container">
        <div class="row d-flex align-items-center">
            ...
            <div class="img-overlay">
              <a href="#">
                <img
                  ...
                  src="assets/images/course-img-1.png"
                  alt=""
                />
              </a>
                        <div class="caption">
          ...
          <div class="col-lg-6 col-md-4 mb-8 d-md-none d-lg-block">
            <div class="img-overlay img-zoom">
              <a href="#">
                <img
                  class="rounded img-fluid w-100"
                  src="assets/images/course-img-3.png"
                  alt=""
                />
              </a>
                                <div class="caption">
          ...
          <div class="col-lg-4 col-md-6 col-12">
            <div class="card border-0">
              <a href="pages/program-single.html" class="img-zoom">
                <img
                  class="rounded img-fluid w-100"
                  src="assets/images/thumb-img-1.jpg"
                  alt=""
                />
              </a>
                                </div>
                                <div class="card border-0">
                                    <div class="card-body mt-n16 bg-white mr-6 rounded-right p-4">
                                        <h3 class="mb-3"> <a href="pages/program-single.html" class="text-inherit">
                                            Life Coaching
                                        </a>
                                        </h3>
                                        <p>
          ...
          <div class="col-lg-4 col-md-6 col-12">
            <div class="card border-0">
              <a href="pages/program-single.html" class="img-zoom"
                ><img
                  class="rounded img-fluid w-100"
                  src="assets/images/thumb-img-2.jpg"
                  alt=""
                />
              </a>
                                    </div>
          ...
          <div class="col-lg-4 d-lg-block d-md-none col-12">
            <div class="card border-0">
              <a href="pages/program-single.html" class="img-zoom"
                ><img
                  class="rounded img-fluid w-100"
                  src="assets/images/thumb-img-3.jpg"
                  alt=""
                />
              </a>
                                        </div>
                                        <div class="card border-0">
                                            <div class="card-body mt-n16 bg-white mr-6 rounded-right p-4">
                                                <h3 class="mb-3"> <a href="pages/program-single.html" class="text-inherit">Leadership
                                                </a>
                                                </h3>
                                                <p>
      ...
      <div class="pt-18">
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 mt-4 text-center">
                <img src="assets/images/logo-digitalocean.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 mt-4 text-center">
            ...
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 mt-4 text-center">
                <img src="assets/images/logo-discord.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 mt-4 text-center">
                <img src="assets/images/logo-intercom.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 mt-4 text-center">
            ...
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 mt-4 text-center">
                <img src="assets/images/logo-paypal.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 mt-4 text-center">
                <img src="assets/images/logo-netflix.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 mt-4 text-center">
                <img src="assets/images/logo-xboxone.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 mt-4 text-center">
            ...
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 mt-4 text-center">
                <img src="assets/images/logo-pinterest.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 mt-4 text-center">
                <img src="assets/images/logo-stripe.svg" alt="" />
              </div>
            </div>
          </div>
        </div>
...
<!-- Mirrored from codescandy.com/coach/v/2.0.0-alpha/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Dec 2020 21:28:28 GMT -->
</html>